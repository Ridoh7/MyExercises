...
public class CommissionEmployee {
    ...
    public CommissionEmployee(String firstName, String lastName, String bvn, double grossSales,
    ...
    private void validateCommissionRate(double rate) {
        if (rate < 0 || rate > 1) {
            throw new IllegalArgumentException("Commission rate has to be between 0 and 1");
        }
    }
